...
def register():
    if request.method == 'POST':
        ...
        sql = "SELECT * FROM THAMBIDURAI_REGISTER WHERE EMAIL = ?"
        ...
        if account:
            ...
            insert_sql = "INSERT INTO THAMBIDURAI_REGISTER (EMAIL, PASSWORD) VALUES (?, ?)"
...
def test():
    ...
    return render_template('booking.html', output1=op1, output2=op2)
